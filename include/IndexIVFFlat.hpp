...
namespace vindex
{
  ...
  public:
    ...
    // void add_core(int64_t n, const float *x, const int64_t *xids, const int64_t *precomputed_idx) override;

    void encode_vectors(int64_t n, const float *x, const int64_t *list_nos, uint8_t *codes, bool include_listnos = false) const override;

    // InvertedListScanner *get_InvertedListScanner(bool store_pairs, const IDSelector *sel) const override;
